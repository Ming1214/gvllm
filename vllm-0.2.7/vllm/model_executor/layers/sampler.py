...
def _guidance_sample(
    ...
    for seq_group in selected_seq_groups:
        ...
        if len(guidance_controller.pre_decoded_token_ids) > 0:
            ...
            search_type = "pre_decoded"
        else:
            get_new_tokens = guidance_controller.pre_decode()
            if get_new_tokens:
                token_id = guidance_controller.pre_decoded_token_ids.pop(0)
...
def _sample(
    ...
    for sampling_type in SamplingType:
        ...
        if sampling_type == SamplingType.GREEDY:
            ...
            guidance_search_logits = logprobs[sample_indices]
        else:
    ...
    for sampling_type in SamplingType:
        ...
        if sampling_type == SamplingType.GREEDY:
            ...
            sample_results = _guidance_sample(seq_groups, guidance_search_logits)
